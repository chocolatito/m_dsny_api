...
RSpec.describe '/genres', type: :request do
  ...
  let(:valid_attributes) do
    { name: 'Genre_@@@', url_picture: 'picture.net/Genre_pic_@@@' }
  end
  ...
  describe 'PATCH /update' do
    context 'with valid parameters' do
      ...
      it 'updates the requested genre' do
        ...
        genre_json = JSON.parse(response.body)
        expect(genre_json['name']).to eq('Genre_@@@+@')
        expect(genre_json['url_picture']).to eq('picture.net/Genre_pic_@@@+@')
      end
